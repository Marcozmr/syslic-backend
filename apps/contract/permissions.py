...
MODEL_NAME = 'Contract'
MODEL_SETTINGS_NAME = 'ContractSettings'
...
class HasOtherPermission(BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        if request.method in READ_METHOD:
            is_true = modules_permissions['contract']['can_read']
            is_true |= modules_permissions['contract']['can_write']
            is_true |= modules_permissions['contract']['can_edit']
            is_true |= modules_permissions['contract']['can_delete']
            return is_true
