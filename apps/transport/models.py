...
class Freight(TenantModel):
    ...
    class Meta:
        ...
        constraints = [
            UniqueConstraint(fields=['id', 'account'], name='unique_freight_id_account'),
            UniqueConstraint(fields=['name', 'account'], name='unique_freight_name_account'),
        ]
...
class Carrier(TenantModel):
    ...
    class Meta:
        ...
        constraints = [
            UniqueConstraint(fields=['id', 'account'], name='unique_carrier_id_account'),
            UniqueConstraint(fields=['cnpj', 'account'], name='unique_carrier_cnpj_account'),
        ]
